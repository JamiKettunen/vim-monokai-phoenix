...
function! s:javascriptMonokaiPhoenixFiletype()
  ...
  hi jsArgsObj guifg=#66D9EF guibg=NONE gui=NONE ctermfg=233 ctermbg=81 cterm=NONE
  ...
  hi jsClass guifg=#66D9EF guibg=NONE gui=NONE ctermfg=233 ctermbg=81  cterm=NONE
  hi jsAsyncKeyword guifg=#66D9EF guibg=NONE gui=NONE ctermfg=233 ctermbg=81 cterm=NONE
  hi jsGlobalObjects guifg=#66D9EF guibg=NONE gui=NONE ctermfg=233 ctermbg=81 cterm=NONE
  hi jsGlobalNodeObjects guifg=#66D9EF guibg=NONE gui=italic ctermfg=233 ctermbg=81 cterm=italic
  hi jsThis guifg=#66D9EF guibg=NONE gui=italic ctermfg=233 ctermbg=81 cterm=italic
  hi jsExceptions guifg=#F92672 guibg=NONE gui=NONE ctermfg=197 ctermbg=NONE cterm=NONE
  hi jsBuiltins guifg=#66D9EF guibg=NONE gui=NONE ctermfg=233 ctermbg=81 cterm=NONE
  hi jsFutureKeys guifg=#66D9EF guibg=NONE gui=NONE ctermfg=233 ctermbg=81 cterm=NONE
  hi jsHtmlEvents guifg=#66D9EF guibg=NONE gui=NONE ctermfg=233 ctermbg=81 cterm=NONE
